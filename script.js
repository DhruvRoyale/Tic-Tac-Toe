...
for (let i = 0; i < 9; i++) {
    current_state[i] = "url(Transparent.png)";
}
...
function game() {
    ...
    if (turn % 2 === 0) {
        ...
        button_clicked.style.backgroundImage = "url(Transparent_X.png)";
    }
    else {
        document.querySelector('#X').style.backgroundColor = "#4F4F4F";
        document.querySelector('#O').style.backgroundColor = "#1C1C1C";

        button_clicked.style.backgroundImage = "url(Transparent_O.png)";
    }
...
function reset() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        document.getElementById(id).style.backgroundImage = "url(Transparent.png)";
